                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            I work with Python, Django, JavaScript, and React to build high-performance web applications.
                        </p>
                        <p className="text-muted-foreground">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href="" className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-all duration-300 hover:scale-105">
                                Download CV
                            </a>
                        </div>
                    </div>
